...
| Transformation contracts | Exact-build static-rule rebinding schemas plus Rust validation that rejects generated authority expansion; complete artifact emission and materialization are not yet implemented |
...
| Transformation emission | Deterministic bounded in-memory transformed-source, canonical match-evidence, and Source Map v3 emission from exact digest-bound plans; audit artifacts and materialization remain pending |
