...
| Transformation emission | Deterministic bounded in-memory transformed-source and canonical match-evidence emission from exact digest-bound plans; source maps, audit artifacts, and materialization remain pending |
