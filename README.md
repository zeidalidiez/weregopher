...
| Transformation runtime | Complete plan → emit → overlay → structural validation → byte verification → managed publication → execution-time lease composition is regression-tested; immutable package views and authority-bearing execution remain pending |
